...
sleep(2); click(719, 596, 1, 0, 'left'); sleep(45) # password save and stay sign in
...
click(276, 503, 2, 0, 'left'); sleep(random.randrange(45, 180)); #кликаем на код 2 раза и выделяем его
