...
hotkey('ctrl', 'c'); sleep(3); click(370, 501, 1, 0, 'left'); sleep(3); click(276, 503, 2, 0, 'left'); sleep(3); hotkey('ctrl', 'c'); sleep(2); click(370, 22, 1, 0, 'left'); sleep(4); click(460, 508, 1, 0, 'left'); sleep(4); hotkey('ctrl', 'v'); sleep(30) # копируем и вставляем
