...
sleep(2)
scroll(-400); sleep(2)
click(278, 357, 1, 0, 'left'); sleep(7); click(341, 577, 1, 0, 'left'); sleep(10); click(683, 541, 1, 0, 'left'); sleep(10); click(683, 541, 1, 0, 'left'); sleep(10); # удаляем сот тел
click(146, 17, 1, 0, 'left'); sleep(5); click(139, 114, 1, 0, 'left'); # переход на гл странницу
click(231, 253, 1, 0, 'left'); sleep(5); click(870, 110, 1, 0, 'left'); # вм и колокольчик
