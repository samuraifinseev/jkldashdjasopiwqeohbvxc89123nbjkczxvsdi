...
#click(20, 59, 1, 0, 'left'); sleep(8); click(451, 460, 1, 0, 'left'); sleep(1); keyboard.write('56981488228Simak', delay=0.25); sleep(2.5); click(717, 622, 1, 0, 'left'); sleep(8) # перелогин на случай краша страницы
